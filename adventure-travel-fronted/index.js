...
const testimonials = [
    {
        quote: "Family, Konkan, Konkan Paryatan - magic mix! We laughed, explored, tasted the Konkan. Three generations, one unforgettable reunion.",
        author: "Bhoshle Family, Vengurla"
    },
    {
        quote: "Adventure, nature, and culture in perfect harmony! Konkan Paryatan made our family trip truly special.",
        author: "Deshpande Family, khavne"
    },
    {
        quote: "From beaches to forts, every moment was a memory. Thank you for an amazing Konkan experience!",
        author: "Patil Family, Shiroda"
    },
    {
        quote: "The food, the scenery, and the laughter — Konkan Paryatan has it all! Highly recommend.",
        author: "Shinde Family, Bhogve"
    },
    {
        quote: "Our kids couldn’t stop smiling! Every stop was fun and educational. A perfect getaway for all ages.",
...
function showTestimonial(index, direction = "next") {
    ...
    quoteEl.style.transform = (direction === "next") ? "translateX(-100%)" : "translateX(100%)";
    quoteEl.style.opacity = 0;
    authorEl.style.transform = (direction === "next") ? "translateX(-100%)" : "translateX(100%)";
